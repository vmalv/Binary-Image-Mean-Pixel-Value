...
def crop_raw(image: Image, length: float, v_shift: int, h_shift: int, dpi: int) -> Image:
    ...
    Arguments:
        ...
        length -- Length and width of scanned squared area in centimeters.
        v_shift -- The number of pixels to shift the image on the vertical axis
        h_shift -- The number of pixels to shift the image on the horizontal axis
        dpi -- Dots per inch (DPI) used to scan the droplet patterns
